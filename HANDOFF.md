...
## 남은 사용자 요청
- ✅ #42 3:3 대형맵 — 완료/배포됨
- #43 게임 시작 BGM + 사운드: 일레븐랩스 API 키 미확보 → 키 위치 사용자 확인 필요. 음악(BGM)은 Gemini Lyria deprecated(2026-05-24), 무료 대안 pyfxr는 SFX만
- #44 포지션 편향 근본: 1v1 maze 미러 + 3v3 팀1 우측 편향 둘 다 잔존. AI 팀협동/포지션 미러 추적 필요
